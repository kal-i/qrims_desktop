...
class _CreatePurchaseOrderViewState extends State<CreatePurchaseOrderView> {
  ...
  Widget _buildForm() {
    ...
    return Form(
      ...
      child: Column(
        children: [
          _buildSupplierInformationSection(),
          const SizedBox(
            height: 50.0,
          ),
  ...
  Widget _buildSupplierInformationSection() {
    return Column(
            ...
            children: [
              Expanded(
                child: CustomFormTextField(
                  ...
                  placeholderText: 'Enter supplier\'s name',
              ...
              Expanded(
                child: CustomFormTextField(
                  label: 'Address',
                  controller: _purposeController,
                  placeholderText: 'Enter supplier\'s address',
                  fillColor: (context.watch<ThemeBloc>().state == AppTheme.light
                      ? AppColor.lightCustomTextBox
                      : AppColor.darkCustomTextBox),
                ),
            ...
            children: [
              Expanded(
                child: CustomFormTextField(
                  ...
                  controller: _purposeController,
                  placeholderText: 'Enter delivery\'s place',
                  fillColor: (context.watch<ThemeBloc>().state == AppTheme.light
                      ? AppColor.lightCustomTextBox
                      : AppColor.darkCustomTextBox),
                ),
              ...
              Expanded(
                child: CustomFormTextField(
                  label: 'Delivery Term',
                  controller: _purposeController,
                  placeholderText: 'Enter delivery\'s term',
                  fillColor: (context.watch<ThemeBloc>().state == AppTheme.light
                      ? AppColor.lightCustomTextBox
                      : AppColor.darkCustomTextBox),
                ),
            ...
            children: [
              ...
              Expanded(
                child: CustomFormTextField(
                  label: 'Payment Term',
                  controller: _purposeController,
                  placeholderText: 'Enter payment\'s term',
                  fillColor: (context.watch<ThemeBloc>().state == AppTheme.light
                      ? AppColor.lightCustomTextBox
                      : AppColor.darkCustomTextBox),
                ),
